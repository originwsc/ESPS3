    ...
    lv_fs_read(&b->f, buf, len * (b->bpp / 8), NULL);
        ...
        switch(b->bpp)
        {
            case 32:
                for(int i = 0; i < len; i++)
                {
                    lv_fs_read(&b->f, color_buf, 4, NULL);
                    color_p[i] = lv_color_make(color_buf[2], color_buf[1], color_buf[0]);
                }
                break;
            case 24:
                for(int i = 0; i < len; i++)
            ...
            case 8:
                for(int i = 0; i < len; i++)
                {
                    ...
                    color_p[i] = lv_color_make(color.red, color.green, color.blue);
                }
                break;
            case 4:
                for(int i = 0; i < len;)
